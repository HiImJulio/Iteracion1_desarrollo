...
class Persona:
        def __init__(self, idpersona,dtrEdad):           
            ...
            self.idVivienda = (-1, -1)
            self.idOficina = (-1, -1)  
             # Significado: piso - edificio - que estoy haciendo : 0.vivienda   1.oficina    2.ocio 
        ...
        def simular_ia(self, hora, simulador):
            ...
            if(self.estado == "sintomatico"):
                 if(self.lugarActual[2] != 0): #en caso de que el individuo no este en la vivienda
                    simulador.irse(self)
                    simulador.meterse(self, self.idVivienda,0)
                    self.lugarActual = (self.idVivienda[0],self.idVivienda[1],0) #actualizacion del sitio actual        
            else:
                if(self.lugarActual[2] == 0 or self.lugarActual[2] == 2): #En caso de que este en casa u ocio
                ...
                elif(self.lugarActual[2] == 1):  #en caso de que este en la oficina 
